  ...
  return (
    <footer className="bg-[#0A2229] md:px-[100px] px-4 py-[50px]  space-y-8 ">
      <div className="md:flex md:justify-between md:items-center border-b  border-[#FFFFFFCC] pb-6 ">
        ...
        <div className="md:space-x-8 space-y-8 mt-10 md:mt-0 md:flex md:flex-row flex-col items-center">
      ...
      <div className="flex md:flex-row flex-row-reverse justify-between md:items-center">
        <div className="md:space-x-8 space-y-8  flex md:flex-row flex-col items-center">
        ...
        <div className="md:space-x-8  space-y-8    flex md:flex-row flex-col  md:items-center">
